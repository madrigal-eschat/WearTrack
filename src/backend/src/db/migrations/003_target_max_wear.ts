...
export default function runMigration003() {
  dbExport.exec(`
    ALTER TABLE categories ADD COLUMN
      initial_target_wear_duration_seconds INTEGER NOT NULL DEFAULT 0;
    ALTER TABLE categories ADD COLUMN initial_max_wear_duration_seconds
      INTEGER;
    ALTER TABLE categories ADD COLUMN break_grace_time
    ...
    UPDATE categories SET
      ...
      initial_target_wear_duration_seconds =
        CAST(initial_wear_duration_seconds * 2 / 3 AS INTEGER),
    ...
    ALTER TABLE sessions RENAME COLUMN calculated_wear_seconds
      TO max_wear_seconds;
    ALTER TABLE sessions ADD COLUMN target_wear_seconds
      INTEGER NOT NULL DEFAULT 0;
    UPDATE sessions SET target_wear_seconds =
